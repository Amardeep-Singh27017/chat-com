                            ...
                            {searchUser.map((user, index) => (
                                ...
                                >
                                    ...
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center rounded-full bg-purple-300/60">
                                        ...
                                        {isOnline[index] && (
                                            <span
                                                className="absolute top-0 right-0 w-3 h-3 bg-green-500 border-2 border-white rounded-full animate-pulse"
                                            />
                                        )}
                                    </div>
                                ...
                                <div className="flex-1 overflow-y-auto max-h-[calc(100vh-160px)] px-1">
                                    {chatUser.map((user, index) => (
                                        ...
                                        >
                                            ...
                                            {/* notification badge  */}
                                            <div>
                                                {newMessagesUsers && newMessagesUsers.recieverId === authUser._id && newMessagesUsers.senderId === user._id ?
                                                    <div className="rounded-full bg-green-500 text-white px-[4px] text-sm">+1</div> : <></>
                                                }
                                            </div>
